...
<nav class="food-nav">
    <ul>
        ...
        <li><a href="#mah">Pakistani</a></li>
        <li><a href="#punjabi">Lahore Special</a></li>
...
<div class="container">
    <!-- ----------------------------------- South Indian-------------------------- -->
    <h1 class="food-h">Pakistani</h1>
    <div class="row" id="south">
    
        <div class="col-lg-3">
        <form action="manage_cart.php" method="POST">
            <div class="card">
                <img src="img/WhatsApp Image 2023-01-12 at 11.19.54 PM.jpeg" alt="">
                <div class="card-body">
        ...
        <div class="col-lg-3">
            <form action="manage_cart.php" method="POST">
            <div class="card">
                <img src="img/WhatsApp Image 2023-01-12 at 11.21.36 PM.jpeg" alt="">
                <div class="card-body">
        ...
        <form action="manage_cart.php" method="POST">
            <div class="card">
                <img src="img/WhatsApp Image 2023-01-12 at 11.23.49 PM.jpeg" alt="">
                <div class="card-body">
        ...
        <form action="manage_cart.php" method="POST">
            <div class="card">
                <img src="img/WhatsApp Image 2023-01-12 at 11.25.20 PM.jpeg" alt="cheese dosa">
                <div class="card-body">
        ...
        <form action="manage_cart.php" method="POST">
            <div class="card">
                <img src="img/WhatsApp Image 2023-01-12 at 11.28.34 PM.jpeg" alt="">
                <div class="card-body">
        ...
        <form action="manage_cart.php" method="POST">
            <div class="card">
                <img src="img/WhatsApp Image 2023-01-12 at 11.26.55 PM.jpeg" alt="">
                <div class="card-body">
                  <h5 class="card-title">qeema</h5>
                    <p class="card-text">Price : Rs 120</p>
                   <button type="submit" name="add_to_cart" class="btnn">Add to Cart</button>
