...
<div class="contact-container">
    ...
    <div class="contact1">
        <div class="contact-symbol">
           <i class="fas fa-hamburger">Hotel</i></div>
        <div class="book-h1">
            <h1>BOOK YOUR <br> HOTEL TODAY</h1>
        </div>
        <div class="book-p">
            <p>Hotels.com Customer Care Number, Contact Address, Email Id. Hotels.com is an <br> 
            Pakistani Most Popular Online Hotel Booking Platforms. Many Pakistani’s looking for the contact.</p>
        </div>
