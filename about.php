         ...
         <div class="about-box-1">
             <div class="box1">
                 ...
                 <div class="box1-text">
                     ...
                     <p class="box1-text-p" style="color:black; font-weight:600; margin-top:6px;"><span class="box1-text-p" style="color:black; font-weight:600; margin-top:6px;">Gulshan-e-iqbal,Pakistan, <br />
Gulshan,Pin-31526 <br />
+92 3162335113<br />
www.ssuet.com</span></p>
